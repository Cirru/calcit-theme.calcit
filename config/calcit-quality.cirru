{} (:schemaVersion 2)
  :definitions $ {}
    |calcit-theme.comp.container/comp-container $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
      ...
      :unresolved 1
      :unsafeCoerce 0
    |calcit-theme.comp.expr/comp-expr $ {} (:codeDynamic 0)
      :codeNil 4
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 0
    ...
    |calcit-theme.comp.expr/handle-active-event! $ {} (:codeDynamic 0)
      ...
      :unresolved 0
      :unsafeCoerce 1
    |calcit-theme.comp.expr/handle-hover! $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 0
    ...
    |calcit-theme.comp.expr/render-expr $ {} (:codeDynamic 0)
      ...
      :unresolved 1
      :unsafeCoerce 0
    |calcit-theme.main/*reel $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
      ...
      :unresolved 1
      :unsafeCoerce 0
    |calcit-theme.main/main! $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 0
    ...
    |calcit-theme.main/render-app! $ {} (:codeDynamic 0)
      ...
      :unresolved 1
      :unsafeCoerce 0
    |calcit-theme.main/repeat! $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 0
    ...
    |calcit-theme.theme/decorate-expr $ {} (:codeDynamic 0)
      ...
      :unresolved 1
      :unsafeCoerce 0
    |calcit-theme.theme/decorate-leaf $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 0
